...
{
    return file_get_contents(get_template_directory_uri() . '/inc/carte-arrondissements.php');
}

// shortcode to use in wysiwyg to call this function : [lorem]
